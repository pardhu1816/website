    ...
    const submitAnalysis = async () => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:5000/api/mood-analysis', {
                ...
                // Return dummy data if backend not connected
                return {
                    ok: true,
                    json: () => Promise.resolve({
                        mood_status: stressLevel > 7 ? 'High Stress' : stressLevel > 4 ? 'Moderate Stress' : 'Stable',
                        stress_category: stressLevel > 6 ? 'Intensive' : 'Mild',
                        recommended_exercise: stressLevel > 7 ? '01' : '02',
                        message: "Your neural engagement indicates high sympathetic activity. Focus on rhythmic breathing."
                    })
                };
            });
