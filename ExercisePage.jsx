...
const API_BASE_URL = 'http://localhost/visual_motor_api/api';
...
const ExercisePage = () => {
    ...
    const saveResult = async () => {
        ...
        // 1. Save to Backend (Node.js)
        try {
            await fetch('http://localhost:5000/api/user-sessions', {
                method: 'POST',
            ...
            console.warn('Backend not reachable, saving to local only');
        }
